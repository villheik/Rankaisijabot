...
@commands.command(
    ...
    aliases=["num"],
    help=(
        "Arpoo satunnaisen numeron. "
        "Oletuksena väliltä 1–100. "
        "Voit antaa maksimirajan muodossa `!number <luku>`."
    ),
)
async def roll(self, ctx, rollRangeEnd=None):
    """
    Arpoo satunnaisen numeron annetun ylärajan sisällä.

    Parametrit:
    - rollRangeEnd: Maksimiraja arvonnalle. Jos ei anneta, käytetään oletuksena 100.
    """
    if rollRangeEnd is None:
